...
def loadPapers(cursor, graph):
    ...
    pos = historicalLayout2(graph, metadata)
...
def historicalLayout2(g,metadata):
    ...
    # Iterate Y-axis force directed layout
    DISTANCE = 20 #Somewhere between 2*k and 20*k
    k = 1
    q = 1
    ...
    while converged == False:
        ...
        for v in g.vertices():
            ...
            for u in g.vertices():
                if u != v:
                    ...
                    if euclideanDistance <= DISTANCE and euclideanDistance != 0:
                        yDisplacement[v] = yDisplacement[v] - C*w*k**2/euclideanDistance*math.sin(math.atan2(deltaY,deltaX))
            ...
            for u in g.get_out_neighbours(v):
                ...
                yDisplacement[v] = yDisplacement[v] + euclideanDistance**2/k*math.sin(math.atan2(deltaY,deltaX))
